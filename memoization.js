...
const verifyAnagramsRecurcion = memoization((string1, string2, i) => {
    i = i || 0;
    if (i < string1.length) {
...
const countingNumbers = memoization((data, i, j, objAmountNumbers, count) => {
    // debugger;
    i = i || 0;
    j = j || 0;
...
const findUniqueWords = memoization((sentence, i, j, uniqueCount, count) => {
    // debugger;
    i = i || 0;
    j = j || 0;
    count = count || 0;
    ...
    if (sentence instanceof Array) {
        ...
        if (j == sentence.length) {
            ...
            j = 0;
            count = 0;
            return findUniqueWords(sentence, ++i, j, uniqueCount, count);
        ...
        return findUniqueWords(sentence);
    }
});

//#5  Написать функцию которая вычисляет вхождение каждого слова в предложение

const findAmountWordsRec = memoization((sentence, i, j, wordsUniqueObj, count) => {
    // debugger;
    i = i || 0;
    j = j || 0;
...
const factorialCalculationRec = memoization((number, i, factorialResult) => {
    i = i || 1;
...
const sumElementsMultipleTwo = memoization((arrayNumbers, i, sumMultipleTwo) => {
    i = i || 0;
...
const sumElementsMultipleThree = memoization((arrayNumbers, i, sumMultipleTwo) => {
    i = i || 0;
    sumMultipleTwo = sumMultipleTwo || 0;
    if (i < arrayNumbers.length) {
...
const sumElementsOnlyPositive = memoization((arrayNumbers, i, sumMultipleTwo) => {
    i = i || 0;
    sumMultipleTwo = sumMultipleTwo || 0;
    if (i < arrayNumbers.length) {
...
const sumElementsOnlyUneven = memoization((arrayNumbers, i, sumMultipleTwo) => {
    i = i || 0;
    sumMultipleTwo = sumMultipleTwo || 0;
    if (i < arrayNumbers.length) {
...
const amountZeroElements = memoization((arrayNumbers, i, amountZero) => {
    i = i || 0;
...
const amountNegativeElements = memoization((arrayNumbers, i, amountNegative) => {
    i = i || 0;
...
const amountPositiveElements = memoization((arrayNumbers, i, amountPositive) => {
    i = i || 0;
...
const amountSimpleElements = memoization((arrayNumbers, i, amountSimple, countDenominator) => {
    i = i || 0;
...
const decimalNumberConversToBinaryNumber = memoization((decimalNumber, arrayBinaryNumber, i) => {
...
const binaryNumberConversToDecimalNumber = memoization((binaryNumber, arrayDegree, i, sumDegree) => {
    i = i || 0;
...
const sumElementsMatrixMultipleTwo = memoization((matrix, i, j, sumMultipleTwo) => {
    i = i || 0;
    j = j || 0;
    sumMultipleTwo = sumMultipleTwo || 0;
    if (i < matrix.length) {
...
const sumElementsMatrixMultipleThree = memoization((matrix, i, j, sumMultipleThree) => {
    i = i || 0;
    j = j || 0;
...
const sumElementsMatrixOnlyPositive = memoization((matrix, i, j, sumPositive) => {
    i = i || 0;
    j = j || 0;
...
const sumElementsMatrixOnlyUneven = memoization((matrix, i, j, sumUneven) => {
    i = i || 0;
    j = j || 0;
...
const amountMatrixZeroElements = memoization((matrix, i, j, amountZero) => {
    i = i || 0;
    j = j || 0;
    amountZero = amountZero || 0;
    if (i < matrix.length) {
...
const amountMatrixNegativeElements = memoization((matrix, i, j, amountNegative) => {
    i = i || 0;
    j = j || 0;
    amountNegative = amountNegative || 0;
    if (i < matrix.length) {
...
const amountMatrixPositiveElements = memoization((matrix, i, j, amountPositive) => {
    i = i || 0;
    j = j || 0;
    amountPositive = amountPositive || 0;
    if (i < matrix.length) {
...
const amountMatrixSimpleElements = memoization((matrix, i, j, amountSimple, countDenominator) => {
    i = i || 0;
    j = j || 0;
    amountSimple = amountSimple || 0;
    countDenominator = countDenominator || 0;
...
const sumRangeMinMax = memoization((min, max, sumFromMinBeforeMax) => {
...
const sumRangeMinMaxMultiplesThree = memoization((min, max, sumMultiplesThree) => {
...
const sumRangeMinMaxOnlyPositive = memoization((min, max, sumOnlyPositiveElements) => {
...
const meanSingleArrayAllElem = memoization((arrElements, i, meanAllElem, countAll) => {
    i = i || 0;
...
const meanSingleArrayEvenElem = memoization((arrElements, i, meanEvenElem, countEven) => {
    i = i || 0;
...
const meanSingleArrayUnevenElem = memoization((arrElements, i, meanUnevenElem, countUneven) => {
    i = i || 0;
...
const meanDimensionalArrayAllElem = memoization((matrix, i, j, meanAllElem, countAll) => {
    i = i || 0;
    j = j || 0;
    meanAllElem = meanAllElem || 0;
    countAll = countAll || 0;
...
const meanDimensionalArrayEvenElem = memoization((matrix, i, j, meanEvenElem, countEven) => {
    i = i || 0;
    j = j || 0;
    meanEvenElem = meanEvenElem || 0;
    countEven = countEven || 0;
...
const meanDimensionalArrayUnevenElem = memoization((matrix, i, j, meanUnevenElem, countUneven) => {
    i = i || 0;
    j = j || 0;
    meanUnevenElem = meanUnevenElem || 0;
    countUneven = countUneven || 0;
...
const transpositionMatrix = memoization((array, newDimensionalArray, i, j, k) => {
    i = i || 0;
    j = j || 0;
    k = k || 0;
...
const sumTwoMatrix = memoization((matrixFirst, matrixSecond, i, j) => {
    i = i || 0;
    j = j || 0;
...
const deleteLineWithZeroElement = memoization((matrix, i) => {
    i = i || 0;
...
const deleteColumnWithZeroElement = memoization((matrix, i) => {
    i = i || 0
